...
```
curl -LO https://github.com/nizartuanku/decoy/releases/latest/download/decoy-free-0.1.2-linux-amd64.tar.gz
curl -LO https://github.com/nizartuanku/decoy/releases/latest/download/SHA256SUMS
sha256sum -c SHA256SUMS
tar xzf decoy-free-0.1.2-linux-amd64.tar.gz && ./decoy
```
